...
{
    public partial class ThemCQHTNN : Form
    {
        private long gid;
        ...
        public ThemCQHTNN(long cecm_program_id, long gid = -1)
        {
            InitializeComponent();
        ...
        private void ThemCQHTNN_Load(object sender, EventArgs e)
        {
