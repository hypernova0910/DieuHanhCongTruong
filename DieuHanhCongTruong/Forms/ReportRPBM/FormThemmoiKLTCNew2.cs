...
{
    public partial class FormThemmoiKLTCNew2 : Form
    {
        ...
        public FormThemmoiKLTCNew2(int i, int main_id, string field_name, string table_name)
        {
            id_BSKQ = i;
        ...
        private void FormThemmoiKLTCNew2_Load(object sender, EventArgs e)
        {
            ...
            if (i != 0)
            {
                ...
                if (datatable.Rows.Count != 0)
                {
                    foreach (DataRow dr in datatable.Rows)
                    {
                        ...
                        tbGhiChu.Text = dr["string3"].ToString();
                    }
                }
            }
        }
            ...
            try
            {
                ...
                if (id_BSKQ == 0)
                {
                    ...
                    cmd2 = new SqlCommand(
                        ...
                        "([table_name],[field_name],[main_id],long1,long2,[string1],[string2],[double1],[double2],string3) " +
                        "Values " +
                        "(@table_name,@field_name,@main_id,@long1,@long2,@string1,@string2,@double1,@double2,@string3)", _Cn);
                ...
                SqlParameter double3 = new SqlParameter("@string3", SqlDbType.NVarChar, 200);
                double3.Value = tbGhiChu.Text;
