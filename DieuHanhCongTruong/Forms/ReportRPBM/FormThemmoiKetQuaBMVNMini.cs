...
{
    public partial class FormThemmoiKetQuaBMVNMini : Form
    {
        ...
        public FormThemmoiKetQuaBMVNMini(int i, int main_id, string field_name, string table_name)
        {
            id_BSKQ = i;
        ...
        private void FormThemmoiKetQuaBMVNMini_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (id_BSKQ == 0)
                {
                    ...
                    cmd2 = new SqlCommand(
                        ...
                        "([table_name],[field_name],[main_id],long1,long2,[string1],string2) " +
                        "Values " +
                        "(@table_name,@field_name,@main_id,@long1,@long2,@string1,@string2)", _Cn);
